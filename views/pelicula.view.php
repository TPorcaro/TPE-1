        ...
        <body>
            <ul>';
                foreach ($peliculas as $pelicula) {
                    $html.= '<li>Nombre: '.$pelicula->nombre.' ID: '.$pelicula->id_pelicula.' <small><a href="borrarpelicula/'.$pelicula->id_pelicula.'">ELIMINAR</a></small><small><a href="paraeditar/'.$pelicula->id_pelicula.'"> EDITAR</a></small></li>';
                }
        $html.= 
        '</ul>
        <div>
